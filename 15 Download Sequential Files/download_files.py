...
#download all the possible combination of files in a link that has numbers at the end in the name at the end...
...
if __name__ == '__main__':
    download_files('https://img.freepik.com/premium-photo/shkoder-town-aerial-panoramic-view-albania_78361-16799.jpg', 'images')
